                                        ...
                                        const int N_cams)
{
        ...
        //std::cout << "NView class Reserving " << M_ << " elements for constr_red_" << std::endl;
        constr_red_.clear();  // Clear previous data before pushing new constraints
        constr_red_.reserve(M_); // Pre-allocate space for efficiency and avoid reallocation issues
        ...
        {       
                ...
                // for (size_t i = 0; i < constr_red_.size(); i++) {
                //         std::cout << "Constraint " << i << ":" << std::endl;
                //         std::cout << "  b: " << constr_red_[i].b << std::endl;
                        
                //         std::cout << "  Fp2: \n" << constr_red_[i].Fp2 << std::endl;
                //         std::cout << "  Fp1: \n" << constr_red_[i].Fp1 << std::endl;
                //         std::cout << "  F: \n" << constr_red_[i].F << std::endl;
                        
                //         std::cout << "  p_i: " << constr_red_[i].p_i.transpose() << std::endl;
                //         std::cout << "  p_j: " << constr_red_[i].p_j.transpose() << std::endl;
                        
                //         std::cout << "  id_1: " << constr_red_[i].id_1 << std::endl;
                //         std::cout << "  id_2: " << constr_red_[i].id_2 << std::endl;
