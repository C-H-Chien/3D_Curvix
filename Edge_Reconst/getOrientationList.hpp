...
namespace GetOrientationList {
    ...
    public:
        ...
        std::pair<Eigen::MatrixXd, Eigen::Vector3d>  getOreListBar(Eigen::MatrixXd Edges_HYPO1, std::vector<Eigen::Matrix3d> All_R, std::vector<Eigen::Vector3d> All_T, Eigen::Matrix3d K1, Eigen::Matrix3d K2, int VALID_INDX, int REFIDX);
